...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-sju3wgm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-sju3wgm.containers.anotherwebservice.com/
...
```
git clone git@github.com:r3dtyyyyyyy/container-sju3wgm.git
cd container-sju3wgm
```
...
```
docker attach container-sju3wgm
```
